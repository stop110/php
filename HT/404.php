  <?php	
					...
					$result = mysql_query($sql);
					 ...
					 $sq="SELECT * FROM entered";
					 $resu = mysql_query($sq);	
					 $count=mysql_num_rows($resu);
					 
					 $mobileErr = $usernameErr  = "";
					 $mobile = $username ="";
					...
					if ($_SERVER["REQUEST_METHOD"] == "POST") {
							...
							$sl="INSERT INTO entered(mobile,username,createddate)values('{$_POST["mobile"]}','{$_POST["username"]}',now())";
							/* 执行INSERT语句 */
							$rt=mysql_query($sl);
							$url = "404.php"; 
  ...
  <body>
	...
	<div class="header">
  	...
  	<div class="total">已有 <span><?php echo "$count";?></span> 人报名</div>
  	      		<h4 style="color:red; text-align:center; font-size:18px;"><?php echo $usernameErr;?></h4>
  	          	<h4 style="color:red; text-align:center; font-size:18px;"><?php echo $mobileErr;?></h4>
